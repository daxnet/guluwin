...
{
    /// <summary>
    /// The implementation of the Visual Basic CodeDom compiler.
    /// </summary>
    public class VBCompiler : Compiler
    {
        ...
        public VBCompiler(bool _generateExecutable, bool _generateInMemory, bool _includeDebugInformation)
