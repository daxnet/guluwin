...
namespace SunnyChen.Common.Windows.ShellApi
{
    public class ShellExecute
    {
        ...
        public ShellExecute(IntPtr _ownerHandle, string _verb, string _path, string _parameters, string _workingFolder, ShowWindowCommands _showMode)
        {
        ...
        public ShellExecute(IntPtr _ownerHandle, string _path)
        {
            OwnerHandle = _ownerHandle;
            Verb = OpenFile;
            Path = _path;
